...
\usepackage{geometry, mathtools, amsthm, amsmath, enumitem, float, dirtytalk, graphicx, textcomp, amssymb, cancel, hyperref, IEEEtrantools, mathrsfs, xfrac, pgfplots, bbding, titlepic}
...
\def\be{\begin{example}\leftskip=1cm\rightskip=1cm$ $\par\nobreak\ignorespaces}
\def\ee{\end{example}}
...
\def\bq{\begin{proof}\leftskip=1cm\rightskip=1cm$ $\par\nobreak\ignorespaces}
\def\eq{\end{proof}}
\def\br{\begin{remark}}
\def\er{\end{remark}}
