...
However, if we take the extra step and turn the tangent space from a vector space to an algebra (by defining an appropriate operation) then we can show that $X_{\gamma,p}$ is actually a derivation of the algebra.  \\
...
\be
Of course, by definition, differential forms are nothing more but a very specific kind of tensors, hence it's a subset of the tensor space. We have $\Omega^0(M)\equiv \mathcal{C}^\infty(M)$ since they are $(0,0)$ tensors a.k.a functions  and $\Omega^1(M)\equiv \Gamma(T^0_1M)\equiv\Gamma(T^*M)$ sincey they are $(0,1)$ tensors a.k.a covectors.
\ee
