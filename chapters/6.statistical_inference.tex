...
Usually, we end up with a very small portion of the population called a \say{sample}. (To not be confused with \say{sample space})
...
\begin{figure}[H]
\includegraphics[scale=0.3]{images/lawoflargenumbers.png}
\centering
