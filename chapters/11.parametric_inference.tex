...
Let us have a collection of i.i.d r.v's $\{ X_{1}, X_{2}, \ldots, X_{n} \}$ following a Bernoulli distribution Bern(p). Our goal is based on the sample $\{ X_{1}, X_{2}, \ldots, X_{n} \}$ to estimate the value of the parameter $p$.\\
